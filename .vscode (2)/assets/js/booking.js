...
promo.addEventListener("keyup",function(){
    ...
    if(this.value.toUpperCase()=="RIDEX50"){
        ...
        const discount =
        Math.round(prices[vehicle.value]*0.5);
...
vehicle.addEventListener("change",()=>{
    ...
    switch(vehicle.value){
        ...
        case "Bike":
            ...
            eta.innerHTML=
            '<i class="fas fa-clock"></i> ETA : 12 Minutes';
        ...
        case "Auto":
            ...
            eta.innerHTML=
            '<i class="fas fa-clock"></i> ETA : 15 Minutes';
        ...
        case "Mini":
            ...
            eta.innerHTML=
            '<i class="fas fa-clock"></i> ETA : 18 Minutes';
        ...
        case "Sedan":
            ...
            eta.innerHTML=
            '<i class="fas fa-clock"></i> ETA : 20 Minutes';
        ...
        case "SUV":
            ...
            eta.innerHTML=
            '<i class="fas fa-clock"></i> ETA : 25 Minutes';
